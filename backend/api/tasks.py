...
def get_all_tasks(
    family_id: str, username: Optional[str] = None, all_family: bool = False
):
...
def update_task_status(task_id: str, task: TaskUpdate):
    ...
    try:
        ...
        # ── 信任指数：完成任务时自动加分 ──
        if task.completed is True and updated.get("username"):
            from service.trust_service import on_task_completed
